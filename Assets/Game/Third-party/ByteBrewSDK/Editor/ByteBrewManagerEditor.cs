...
namespace ByteBrewSDK
{
    ...
    public class ByteBrewEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            ByteBrewSettings manager = AssetDatabase.LoadAssetAtPath<ByteBrewSettings>("Assets/Game/Third-party/ByteBrewSDK/Resources/ByteBrewSettings.asset");

            Texture bytebrewLogo = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Game/Third-party/ByteBrewSDK/Images/bytebrewfulllogo.png", typeof(Texture));
